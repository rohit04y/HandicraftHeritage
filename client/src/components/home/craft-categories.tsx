...
export default function CraftCategories() {
  ...
  console.log("CraftCategories data:", { categories, isLoading, error });
  
  return (
    <section id="crafts" className="py-16 md:py-24 bg-gradient-to-b from-[var(--color-beige)] to-[var(--color-clay)]/30 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories?.map((category: Category) => {
              ...
              return (
                <div 
                  key={category.id} 
                  className="category-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-lg z-10"
                >
